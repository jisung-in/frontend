...
const LikeButton = ({ isLike, onClick }: LikeButtonProps) => {
  return isLike ? (
    ...
    <div
      className="flex items-center justify-center font-Pretendard font-medium text-[21px] text-[#656565] px-[10px] border-[#D9D9D9] border border-solid rounded-[3px] hover:bg-[#FBFBFB] cursor-pointer"
      onClick={onClick}
    >
      좋아요
    </div>
