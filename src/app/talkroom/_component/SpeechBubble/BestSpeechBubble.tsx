...
interface BestSpeechBubbleProps {
  content?: string;
}

const BestSpeechBubble = ({ content }: BestSpeechBubbleProps) => {
  ...
  return (
    <div className="relative bg-white rounded-[15px] mb-[97px]">
      <div className="pt-[8px] pb-[12px] ml-[22px]">
        <Crown />
        <TalkCommentHeaderMain>
          <TalkCommentHeaderMain.Best>1(넘버링)</TalkCommentHeaderMain.Best>
...
export default BestSpeechBubble;
